        ...
        <div className="flex items-center gap-3">
          ...
          <div className="space-y-0.5">
             <div className="flex items-center gap-2">
                ...
                <Badge className={`text-[10px] font-bold border-none uppercase px-2 h-5 tracking-wide ${
         ...
         <Card className="md:col-span-2 border-border shadow-sm rounded-xl bg-card overflow-hidden">
            <div className="p-8 space-y-12">
               ...
               <div className="flex justify-between items-start">
                  <div className="space-y-4">
                     <div className="flex items-center gap-2">
                        ...
                        <span className="text-lg font-bold tracking-tighter">RideNow Pro</span>
                     </div>
                     <div className="text-[11px] text-muted-foreground font-medium leading-relaxed">
                        RideNow Logistics Limited<br />
               ...
               <div className="pt-12 text-center border-t border-border/50 border-dashed">
                  <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Thank you for commuting with RideNow Pro</p>
               </div>
            </div>
         </Card>
